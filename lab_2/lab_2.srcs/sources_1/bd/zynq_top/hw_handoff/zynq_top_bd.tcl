...
CONFIG.ASSOCIATED_BUSIF {sss} \
 ] $fclk0
  set frst0 [ create_bd_port -dir O frst0 ]
  set usr_addr [ create_bd_port -dir O -from 15 -to 0 usr_addr ]
  set usr_rdata [ create_bd_port -dir I -from 31 -to 0 usr_rdata ]
  set usr_rden [ create_bd_port -dir O usr_rden ]
  set usr_wdata [ create_bd_port -dir O -from 31 -to 0 usr_wdata ]
  set usr_wren [ create_bd_port -dir O usr_wren ]

  # Create instance: axi_slave_if_0, and set properties
  set axi_slave_if_0 [ create_bd_cell -type ip -vlnv xilinx.com:user:axi_slave_if:1.0 axi_slave_if_0 ]
...
CONFIG.NUM_MI {1} \
  ...
  connect_bd_intf_net -intf_net ps7_0_axi_periph_M00_AXI [get_bd_intf_pins axi_slave_if_0/S_AXI] [get_bd_intf_pins ps7_0_axi_periph/M00_AXI]

  # Create port connections
  connect_bd_net -net axi_slave_if_0_usr_axi_addr [get_bd_ports usr_addr] [get_bd_pins axi_slave_if_0/usr_axi_addr]
  connect_bd_net -net axi_slave_if_0_usr_axi_rden [get_bd_ports usr_rden] [get_bd_pins axi_slave_if_0/usr_axi_rden]
  connect_bd_net -net axi_slave_if_0_usr_axi_wdata [get_bd_ports usr_wdata] [get_bd_pins axi_slave_if_0/usr_axi_wdata]
  connect_bd_net -net axi_slave_if_0_usr_axi_wren [get_bd_ports usr_wren] [get_bd_pins axi_slave_if_0/usr_axi_wren]
  connect_bd_net -net processing_system7_0_FCLK_CLK0 [get_bd_ports fclk0] [get_bd_pins axi_slave_if_0/S_AXI_ACLK] [get_bd_pins processing_system7_0/FCLK_CLK0] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK] [get_bd_pins ps7_0_axi_periph/ACLK] [get_bd_pins ps7_0_axi_periph/M00_ACLK] [get_bd_pins ps7_0_axi_periph/S00_ACLK] [get_bd_pins rst_ps7_0_100M/slowest_sync_clk]
  connect_bd_net -net processing_system7_0_FCLK_RESET0_N [get_bd_ports frst0] [get_bd_pins processing_system7_0/FCLK_RESET0_N] [get_bd_pins rst_ps7_0_100M/ext_reset_in]
  connect_bd_net -net rst_ps7_0_100M_interconnect_aresetn [get_bd_pins axi_slave_if_0/S_AXI_ARESETN] [get_bd_pins ps7_0_axi_periph/ARESETN] [get_bd_pins rst_ps7_0_100M/interconnect_aresetn]
  ...
  connect_bd_net -net usr_rdata_1 [get_bd_ports usr_rdata] [get_bd_pins axi_slave_if_0/usr_axi_rdata]

  # Create address segments
  create_bd_addr_seg -range 0x00010000 -offset 0x40000000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs axi_slave_if_0/S_AXI/reg0] SEG_axi_slave_if_0_reg0
...
preplace port fclk0 -pg 1 -y 640 -defaultsOSRD -left
preplace port usr_rden -pg 1 -y 480 -defaultsOSRD
preplace port FIXED_IO -pg 1 -y 260 -defaultsOSRD
preplace port usr_wren -pg 1 -y 460 -defaultsOSRD
preplace port frst0 -pg 1 -y 660 -defaultsOSRD -left
preplace portBus usr_wdata -pg 1 -y 500 -defaultsOSRD
preplace portBus usr_addr -pg 1 -y 440 -defaultsOSRD
preplace portBus usr_rdata -pg 1 -y 390 -defaultsOSRD -right
preplace inst ps7_0_axi_periph -pg 1 -lvl 2 -y 440 -defaultsOSRD
preplace inst rst_ps7_0_100M -pg 1 -lvl 2 -y 680 -defaultsOSRD -resize 245 124
preplace inst axi_slave_if_0 -pg 1 -lvl 3 -y 470 -defaultsOSRD
preplace inst processing_system7_0 -pg 1 -lvl 1 -y 400 -defaultsOSRD -resize 349 436
preplace netloc processing_system7_0_DDR 1 1 3 NJ 220 N 220 N
preplace netloc axi_slave_if_0_usr_axi_rden 1 3 1 NJ
preplace netloc axi_slave_if_0_usr_axi_wdata 1 3 1 NJ
preplace netloc processing_system7_0_M_AXI_GP0 1 1 1 N
preplace netloc rst_ps7_0_100M_peripheral_aresetn 1 1 2 450 580 750
preplace netloc usr_rdata_1 1 2 2 750 390 N
preplace netloc processing_system7_0_FCLK_RESET0_N 1 0 2 NJ 660 420
preplace netloc processing_system7_0_FIXED_IO 1 1 3 NJ 260 N 260 N
preplace netloc processing_system7_0_FCLK_CLK0 1 0 3 20 640 430 560 750
preplace netloc ps7_0_axi_periph_M00_AXI 1 2 1 N
preplace netloc axi_slave_if_0_usr_axi_addr 1 3 1 N
preplace netloc axi_slave_if_0_usr_axi_wren 1 3 1 N
preplace netloc rst_ps7_0_100M_interconnect_aresetn 1 1 2 440 570 760
levelinfo -pg 1 0 220 600 920 1090 -top 0 -bot 760
",
}
